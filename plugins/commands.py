...
buttons=InlineKeyboardMarkup(
        [
            ...
            [
                InlineKeyboardButton("Source Code", url="https://github.com/jbrofficial/forewordbot1"),
                InlineKeyboardButton("Report a Bug", url="https://t.me/crazyrocks")
            ]
        ]
        )
...
async def cb_abt(bot, cb):
    ...
    reply_markup=InlineKeyboardMarkup(
        [
            [
                InlineKeyboardButton("Source", url="https://github.com/jbrofficial/forewordbot1"),
            ]
        ]
    )
    )
